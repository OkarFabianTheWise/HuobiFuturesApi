#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Author  : FabianThewise
# @github  : https://github.com/OkarFabianTheWise
# 202: place_buy_order
...
class HuobiDM:
    ...
    def get_contract_index(self, symbol):
        ...
        #'/api/v1/contract_index'
        return http_get_request(url, params)
    
    def linear_trade(self, symbol):
        """
        :symbol    "BTC","ETH"...
        """
        params = {'symbol': symbol}
    ...
    def swap_historical_funding_rate(self, contract_code):
        """
        :contract_code    "BTC","ETH"...
        """
        params = {'contract_code': contract_code}
    ...
    def swap_funding_rate(self, contract_code):
        """
        :contract_code    "BTC","ETH"...
        """
        params = {'contract_code': contract_code}
    ...
    def swap_ladder_margin(self, contract_code):
        """
        :contract_code    "BTC","ETH"...
        """
        params = {'contract_code': contract_code}
    ...
    def swap_adjustfactor(self, contract_code):
        """
        :contract_code    "BTC","ETH"...
        """
        params = {'contract_code': contract_code}
    ...
    def get_contract_trade(self, symbol, size=1):
        """
        :param symbol: { BTC_CW, BTC_NW, BTC_CQ, etc. }
        :return:
        """
        params = {'symbol': symbol,
                  'size' : size}
    ...
    def get_index_info(self, symbol,):
        ...
        url = self.__url + '/linear-swap-api/v3/get_index_info'
        return http_get_request(url, params)
    ...
    def place_buy_order(self,
        ...
        request_path = '/api/v3/contract_order'
        return api_key_post(self.__url, request_path, params, self.__access_key, self.__secret_key)
    ...
    # 合约下单
    def swap_account_info(self,):
        
        params = {}
        
        request_path = '/linear-swap-api/v3/unified_account_info'
        return api_key_post(self.__url, request_path, params, self.__access_key, self.__secret_key)
    
    def swap_cross_trigger_order(self, 
                                 symbol, 
                                 lever_rate, 
                                 price, 
                                 volume):
